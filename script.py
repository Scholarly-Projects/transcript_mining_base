...
TAGS = {
    ...
    "conflict": {
        ...
        "terms": [
            ...
            "prisoner of war", "rebellion", "refugee",
    ...
    "education": {
        ...
        "terms": [
            ...
            "field trip", "financial aid", "graduation", "grant",
            "group work", "homework", "individualized education plan (iep)",
            "learning", "library", "literacy", "numeracy",
    ...
    "environment": {
        ...
        "terms": [
            ...
            "ozone", "pollution", "recycling", "renewable energy",
    ...
    "health": {
        ...
        "terms": [
            ...
            "mental health", "mumps", "neurasthenia", "nurse", "pain", "pandemic",
            "pharmacy", "physical therapy", "pneumonia", "prescription", "quarantine",
            ...
            "vaccination", "vaccine", "virus", "whooping cough",
            "yellow fever",
        ],
    },
    "history": {
    ...
    "LCOH Corporations": {
            ...
            "terms": [
                ...
                "Weiser National Bank", "Weyerhaeuser Timber", "Weyerhaeuser", "White Pine Mill",
    ...
    "LCOH Places": {
        ...
        "terms": [
            ...
            "hood river", "hoodoo", "hoodoo mountains", "hoquiam",
    ...
    "literature": {
        ...
        "terms": [
            ...
            "classic literature", "dialogue", "editing",
            ...
            "nonfiction", "novella", "playwright", "plot", "poetry",
            "prologue", "prose", "publishing", "pulp novel", "short story",
    ...
    "manual_labor": {
        ...
        "terms": [
            ...
            "service worker", "sick leave", "termination", "union",
    ...
    "migration": {
        ...
        "terms": [
            ...
            "dislocation", "dispersion", "displaced person", "displacement", "Ellis Island",
    ...
    "music_and_theater": {
        "enabled": True,
        "terms": [
            "accordion", "actor", "actress", "arpeggio",
            "autoharp", "backstage", "banjo", "bass fiddle",
    ...
    "religion": {
        ...
        "terms": [
            ...
            "confession", "congregation", "creed", "deacon",
            ...
            "repentance", "revival", "sacrament", "sacred",
    ...
    "technology": {
        ...
        "terms": [
            ...
            "refrigerator", "remote control", "satellite", "scanner", 
    ...
    "transportation": {
        ...
        "terms": [
            ...
            "engineer", "ferry", "ferry landing", "ferryman",
            ...
            "switch track", "timetable", "touring car",
