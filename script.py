...
TAGS = {
    "agriculture": {
        ...
        "terms": [
            ...
            "irrigation", "livestock", "milking", "orchard", "organic",
            "pasture", "plow", "potato", "poultry", "ranch", "rural", "seed",
            "shovel", "silage", "soybean", "sustainable", "thresher",
            "tractor", "trailer", "weeding", "wheat",
        ],
    },
    "animal": {
        "enabled": False,
        "terms": [
            "badger", "bear den", "beaver", "bison", "bluebird", "buck",
            ...
            "salmon hatchery", "skunk", "snake bite", "sparrow", "squirrel",
            "stag", "steelhead", "toad", "turkey", "weasel", "whale pod",
            "wolf pack", "wolves",
        ],
    },
    "basque": {
    ...
    "cinema": {
        ...
        "terms": [
            ...
            "cameo", "camerawork", "cinema", "cinematography", "climax",
            ...
            "movie theater", "narrative", "opening credits", "plot",
    ...
    "LCOH Corporations": {
        "enabled": True,
        "terms": [
            "Dernham and Kaufmann", "Gallup Lumber Yard",
            "Hodgin's Drug Store", "Humbird Lumber", "McGoldrick Lumber",
            "Olson & Johnson", "Pleasant Home", "Polson Logging", "Rosauers",
            "Rutledge Lumber and Manufacturing", "Troy Lumber",
            "Washington, Idaho & Montana Railway", "Weyerhaeuser Timber",
            "White Pine Mill", "WI&M", "Winters and Godsworth",
            "Winton Lumber",
        ],
    },
    "LCOH Eastern European": {
        ...
        "terms": [
            ...
            "Hungarian", "Hunk", "Hunkie", "Hunky", "Polack", "Polish",
    ...
    "LCOH Flora & Fauna": {
        ...
        "terms": [
            ...
            "Buffalo", "Bunchgrass", "Camas", "Catface", "Cayuse", "Chicken",
    ...
    "LCOH People": {
        ...
        "terms": [
            ...
            "Old Sundown Jackson", "Ole Bohman", "Ollie Bowman",
    ...
    "LCOH Thrashing": {
        ...
        "terms": [
            ...
            "Harvest Crew", "Header", "Header Box", "Header Puncher",
            "Sack Sewer", "Self-Feeder", "Separator", "Separator Man", "Sheaf",
            "Sheaves", "Shock", "Shockers", "Shocking", "Spike Pitcher",
    ...
    "leisure": {
        "enabled": True,
        "terms": [
            "activity", "adventure", "barbecue", "beach", "biking",
            "board game", "boating", "bonfire", "campfire", "camping",
            "canoeing", "card game", "cycling", "dance", "entertainment",
            "fishing", "fun", "game", "gardening", "hike", "hiking", "hobby",
            "hunting", "kayaking", "lake", "leisure", "pastime", "photography",
